...
class Notification {
	...
	public function getNotifications($data, $limit) {
		...
		$num_iterations = 0;
		$count = 1; //Nombre de message posté
		...
		if($count > $limit)
			...
			$return_string .= "<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: center;'>Pas de notification</p>";
	...
	public function insertNotification($post_id, $user_to, $type) {
		...
		switch($type) {
			case 'comment':
				$message = $userLoggedInName . " A commenté votre publication";
				break;
			case 'like':
				$message = $userLoggedInName . " A aimé votre publication";
				break;
			case 'profile_post':
				$message = $userLoggedInName . " A publier sur votre profil";
				break;
			case 'comment_non_owner':
				$message = $userLoggedInName . " A commenté sur la même publication que vous";
				break;
			case 'profile_comment':
				$message = $userLoggedInName . " A coommenté sur votre profil";
				break;
		}
